...
static const char *const yytname[] =
{
  ...
  "STATIC", "STRUCT", "SWITCH", "TYPEDEF", "VOID", "VOLATILE", "WHILE",
  ...
  "STRING_LITERAL", "$accept", "ROOT", "primary_expression", YY_NULLPTR
};
#endif
